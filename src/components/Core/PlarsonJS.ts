...
/**
 * Интерфейс описывающий структуру конфигурации плагина при его инициализации
 *
 * Содержит:
...
/**
 * Интерфейс описывающий структуру данных плагина, в таком формате все плагины хранятся в памяти
 *
 * Содержит:
...
/**
 * Интерфейс описывающий структуру хранения данных всех плагинов
 */
...
/**
 * Интерфейс описывающий структуру списка плагинов для передачи её в метод, при вызове плагина с plugins[...]
 */
